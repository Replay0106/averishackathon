  ...
  return (
    <div>
      ...
      <div className="panel overflow-hidden">
        <div className="grid grid-cols-[70px_170px_minmax(0,1.3fr)_minmax(180px,1.2fr)_minmax(0,1.4fr)] gap-4 border-b border-white/[0.07] px-6 py-3 max-lg:hidden">
        ...
        <AnimatePresence initial={false}>
          {audit.blocks.map((b) => (
            <motion.div key={b.index} layout initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-[70px_170px_minmax(0,1.3fr)_minmax(180px,1.2fr)_minmax(0,1.4fr)] items-center gap-4 border-b border-white/[0.05] px-6 py-3 last:border-0 max-lg:grid-cols-[60px_1fr]">
              ...
              <span className="num truncate text-[12px] text-ink2 max-lg:hidden" title={b.email_id}>{b.email_id}</span>
